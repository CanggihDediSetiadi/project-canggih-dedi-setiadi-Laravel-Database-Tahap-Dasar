            ...
            <div class="p-5 bg-light rounded-3 col-xl-4 border">
                ...
                <div class="row">
                    <div class="col-md-6 d-grid">
                        <a href="<?php echo e(route('employees.edit', $employee->employee_id)); ?>"
                            class="btn btn-outline-primary btn-lg mt-3"><i class="bi-pencil-square
me-2"></i> Edit</a>
                    </div>
                    <div class="col-md-6 d-grid">
...
<?php /**PATH E:\SI FRAMEWORK\projek-canggih-dedi-setiadi\resources\views/employee/show.blade.php ENDPATH**/ ?>